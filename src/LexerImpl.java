...
public class LexerImpl implements Lexer {
    ...
    public TokenList scan(String input) {
        ...
        while (start_pos < input.length()) {
            ...
            EnumMap<TokenType, Boolean> current_accept;
